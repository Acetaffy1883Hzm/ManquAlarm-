...
/** A best-effort, inexact safety check independent of the service's Handler. */
public final class WatchRecovery {
    ...
    private static PendingIntent intent(Context c){return PendingIntent.getBroadcast(c,204,new Intent(c,ActionReceiver.class).setAction(ACTION),PendingIntent.FLAG_UPDATE_CURRENT|PendingIntent.FLAG_IMMUTABLE);}
