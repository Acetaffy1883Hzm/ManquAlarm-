...
final class AlarmOverlay {
    ...
    void show(String title,boolean test,int duration,int snooze,Runnable dismiss,Runnable later){
        ...
        card.addView(text(test?"满区闹钟 · 响铃测试":"满区闹钟 · 灰泽满开播了",21,true));
        ...
        p.gravity=Gravity.CENTER;p.setTitle("满区闹钟响铃控制");
